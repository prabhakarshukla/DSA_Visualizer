      ...
      <div className="mx-auto w-full max-w-6xl space-y-6">
        ...
        <section className="grid grid-cols-1 gap-4 lg:grid-cols-[360px_1fr]">
          <div className="rounded-3xl border border-[#D8CCA3] bg-[#F7F1DD]/90 p-6 shadow-[0_10px_30px_rgba(15,23,42,0.08)]">
            <h2 className="text-lg font-semibold text-[#4B5320]">Circular Queue Visual</h2>
                        ...
                        <AnimatePresence>
                          {orderedQueue.map((value, idx) => (
                            <motion.div
                              ...
                              className="rounded-lg border border-[#D8CCA3] bg-[#F7F1DD] px-3 py-2 text-sm font-semibold text-[#4B5320] shadow-sm"
                            >
                              {value}
                            </motion.div>
                          ))}
