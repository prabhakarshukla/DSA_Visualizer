    ...
    <main className="min-h-screen bg-[#f4f7fb] px-4 py-10 text-slate-900 sm:px-6 lg:px-8">
      <div className="mx-auto w-full max-w-6xl space-y-6">
        ...
        <section className="rounded-3xl border border-slate-200 bg-white/90 p-6 shadow-[0_10px_30px_rgba(15,23,42,0.08)] sm:p-8">
          <h1 className="text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">Double Ended Queue Visualizer</h1>
          <p className="mt-1 text-sm font-medium text-blue-700">Also called Deque</p>
          ...
          <div className="mt-4 grid grid-cols-2 gap-2 sm:grid-cols-3 lg:grid-cols-9">
            <button onClick={handleInsertFront} className="rounded-xl bg-slate-900 px-3 py-2 text-sm font-medium text-white hover:bg-slate-800">Insert Front</button>
            <button onClick={handleInsertRear} className="rounded-xl bg-slate-900 px-3 py-2 text-sm font-medium text-white hover:bg-slate-800">Insert Rear</button>
            <button onClick={handleDeleteFront} className="rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50">Delete Front</button>
            <button onClick={handleDeleteRear} className="rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50">Delete Rear</button>
            ...
            <button onClick={handlePeekRear} className="inline-flex items-center justify-center gap-1 rounded-xl bg-blue-600 px-3 py-2 text-sm font-medium text-white hover:bg-blue-500"><Eye className="h-4 w-4" />Peek Rear</button>
        ...
        <section className="grid grid-cols-1 gap-4 lg:grid-cols-[360px_1fr]">
          <div className="rounded-3xl border border-slate-200 bg-white/90 p-6 shadow-[0_10px_30px_rgba(15,23,42,0.08)]">
            <h2 className="text-lg font-semibold text-slate-900">Double Ended Queue Visual</h2>
            ...
            <div className="mt-4 rounded-2xl border border-slate-200 bg-slate-50 p-4">
              ...
              <div className="mb-2 flex justify-between text-xs font-semibold text-blue-700"><span className={highlightFront ? "text-emerald-700" : ""}>FRONT</span><span className={highlightRear ? "text-emerald-700" : ""}>REAR</span></div>
              <div className="mb-2 flex justify-between text-blue-600"><ArrowDown className="h-4 w-4" /><ArrowDown className="h-4 w-4" /></div>
            ...
            <div className="mt-4 rounded-2xl border border-blue-200 bg-blue-50 p-4">
              <p className="text-sm font-semibold text-blue-800">Queue vs Double Ended Queue</p>
