    ...
    <main className="min-h-screen bg-[#f4f7fb] px-4 py-10 text-slate-900 sm:px-6 lg:px-8">
      <div className="mx-auto w-full max-w-6xl space-y-6">
        ...
        <section className="rounded-3xl border border-slate-200 bg-white/90 p-6 shadow-[0_10px_30px_rgba(15,23,42,0.08)] sm:p-8">
          <h1 className="text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">Singly Linked List Visualizer</h1>
        ...
        <section className="rounded-3xl border border-slate-200 bg-white/90 p-6 shadow-[0_10px_30px_rgba(15,23,42,0.08)] sm:p-8">
          <h2 className="text-lg font-semibold text-slate-900">Linked List Visual Area</h2>

          <div className="mt-4 overflow-x-auto rounded-2xl border border-slate-200 bg-slate-50 p-4">
            {linkedList.length === 0 ? (
              <div className="flex items-center gap-2 text-sm text-slate-500">
                <span className="rounded-full border border-cyan-200 bg-cyan-50 px-2 py-0.5 text-cyan-700">HEAD stores NULL</span>
                <ArrowRight className="h-4 w-4 text-slate-400" />
                <span>NULL</span>
              </div>
            ) : (
              <div className="min-w-max">
                <div className="mb-2 flex items-center gap-2 text-xs font-medium text-cyan-700">
                  <span className="rounded-full border border-cyan-200 bg-cyan-50 px-2 py-0.5">HEAD stores {headAddress}</span>
                ...
                <motion.div layout className="flex items-center gap-2">
                        ...
                        >
                          ...
                          >
                            <div className="flex border-b border-slate-200">
                              <div className="border-r border-slate-300 px-4 py-2 text-center">
                                <p className="text-xs text-slate-500">data</p>
                                <p className="text-sm font-semibold text-slate-900">{value}</p>
                              </div>
                              <div className="px-4 py-2 text-center">
                                <p className="text-xs text-slate-500">next</p>
                                <p className="text-sm font-semibold text-slate-900">{index === linkedList.length - 1 ? "NULL" : addressOf(index + 1)}</p>
                              </div>
                            </div>
                  ...
                  <span className="rounded-full border border-slate-300 bg-white px-2 py-0.5 text-xs font-medium text-slate-600">NULL</span>
                </motion.div>
              </div>
            )}
          </div>
