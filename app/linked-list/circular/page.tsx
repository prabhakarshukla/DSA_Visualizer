    ...
    <main className="min-h-screen bg-[#F1E8C7] px-4 py-10 text-[#4B5320] sm:px-6 lg:px-8">
      <div className="mx-auto w-full max-w-6xl space-y-6">
        ...
        <section className="rounded-3xl border border-[#D8CCA3] bg-[#F7F1DD]/90 p-6 shadow-[0_10px_30px_rgba(15,23,42,0.08)] sm:p-8">
          <h1 className="text-3xl font-bold tracking-tight text-[#4B5320] sm:text-4xl">Circular Linked List Visualizer</h1>
        ...
        <section className="rounded-3xl border border-[#D8CCA3] bg-[#F7F1DD]/90 p-6 shadow-[0_10px_30px_rgba(15,23,42,0.08)] sm:p-8">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <h2 className="text-lg font-semibold text-[#4B5320]">Circular Linked List Visual Area</h2>
            ...
            {list.length === 0 ? (
              ...
              <div className="min-w-max">
                        ...
                        >
                          ...
                          >
                            <div className="flex border-b border-[#D8CCA3] text-center">
                              <div className="border-r border-[#D8CCA3] px-4 py-2">
                          ...
                          {index < list.length - 1 && <span className="text-[#D8CCA3]">&rarr;</span>}
                        </motion.div>
                      );
                    })}
                  </AnimatePresence>
                ...
                <motion.div
                  ...
                  className="mt-3 flex items-center gap-2 rounded-xl border border-[#AAB76A] bg-[#F7F1DD] px-3 py-2 text-xs font-medium text-[#7D8F3B]"
                >
        ...
        <section className="grid grid-cols-1 gap-4 lg:grid-cols-2">
          <div className="rounded-3xl border border-[#D8CCA3] bg-[#F7F1DD]/90 p-6 shadow-[0_10px_30px_rgba(15,23,42,0.08)]">
            ...
            <div className="mt-4 space-y-3 text-sm">
              ...
              <div>
                <p className="text-xs font-semibold uppercase tracking-wide text-[#9CA763]">Final circular linked list</p>
