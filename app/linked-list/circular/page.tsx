            ...
            {list.length === 0 ? (
              ...
              <div className="min-w-max">
                ...
                <motion.div
                  ...
                  className="mt-3 flex items-center gap-2 rounded-xl border border-[#AAB76A] bg-[#F7F1DD] px-3 py-2 text-xs font-medium text-[#556B2F]"
                >
        ...
        <section className="grid grid-cols-1 gap-4 lg:grid-cols-2">
          <div className="rounded-3xl border border-[#D8CCA3] bg-[#F7F1DD]/90 p-6 shadow-[0_10px_30px_rgba(15,23,42,0.08)]">
            ...
            <div className="mt-4 space-y-3 text-sm">
              ...
              <div>
                <p className="text-xs font-semibold uppercase tracking-wide text-[#556B2F]">Final circular linked list</p>
