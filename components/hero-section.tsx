...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden px-4 pt-12 pb-8 sm:px-6 lg:px-8">
      <div className="absolute inset-0 -z-10 bg-[radial-gradient(#bfdbfe_1px,transparent_1px)] [background-size:18px_18px] opacity-55" />
      <div className="absolute -top-20 right-0 -z-10 h-64 w-64 rounded-full bg-cyan-200/40 blur-3xl" />
      ...
      <div className="mx-auto grid w-full max-w-6xl grid-cols-1 gap-8 lg:grid-cols-2 lg:items-center">
        <div className="space-y-6">
          ...
          <motion.p
            ...
            className="max-w-xl text-base leading-7 text-slate-700 sm:text-lg"
          >
        ...
        <motion.div
          ...
          className="rounded-3xl border border-slate-200 bg-white/90 p-5 shadow-[0_10px_30px_rgba(15,23,42,0.08)]"
        >
          <p className="mb-3 text-sm font-semibold text-slate-700">Visualizer Preview</p>

          <div className="rounded-2xl bg-slate-50 p-4">
            <p className="mb-2 text-xs font-semibold uppercase tracking-wide text-slate-500">Array</p>
            <div className="flex flex-wrap items-center gap-2">
              {arrayValues.map((value, index) => (
                <motion.div
                  ...
                  className="rounded-lg border border-blue-200 bg-blue-50 px-3 py-2 text-sm font-semibold text-slate-800"
                >
                  [{value}]
                </motion.div>
              ))}
            ...
            <p className="mt-4 mb-2 text-xs font-semibold uppercase tracking-wide text-slate-500">Linked List</p>
              ...
              {linkedValues.map((value, index) => (
                <motion.div key={value} className="flex items-center gap-2">
                  <motion.div
                    ...
                    className="rounded-xl border border-cyan-200 bg-cyan-50 px-4 py-1.5 text-sm font-semibold text-slate-800"
                  >
                    {value}
                  </motion.div>
          ...
          <div className="mt-4 rounded-2xl border border-slate-200 bg-white p-4">
            <p className="mb-2 text-xs font-semibold uppercase tracking-wide text-slate-500">Operation Log</p>
